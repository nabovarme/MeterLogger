...
use constant FLASH_COMMAND => 'python3.9 -m esptool -p ' . SERIAL_PORT . ' -b 1500000 write_flash --flash_size 1MB --flash_mode dout 0xFE000 firmware/blank.bin 0xFC000 firmware/esp_init_data_default_112th_byte_0x03.bin 0x00000 firmware/0x00000.bin 0x10000 firmware/0x10000.bin 0x60000 webpages.espfs';
